...
- Prefer deterministic prefilter decisions for clearly non-actor shapes.
- Leave ambiguous actor-vs-nonactor cases available for existing LLM/adjudication paths where those paths exist.
