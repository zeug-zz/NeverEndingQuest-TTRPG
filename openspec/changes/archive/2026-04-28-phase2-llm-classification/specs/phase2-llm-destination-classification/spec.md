# Phase 2 LLM Destination Phrase Classification

## Purpose

Classify ambiguous authored destination phrases as canonical travel aliases, quest objectives, or evocative prose, preventing false travel probe failures.
