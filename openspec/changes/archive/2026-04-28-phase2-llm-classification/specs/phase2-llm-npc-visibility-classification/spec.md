# Phase 2 LLM NPC Visibility Classification

## Purpose

Classify authored NPC mentions as visible presence, hidden/reveal structure, or lore-only references to prevent semantic probe confusion.
