...
Define the canonical human-readable Homebrewery V3 style reference document. This artifact serves as the authoritative description of Homebrewery V3 formatting conventions for developers writing adventure generators and for manual author reference.
