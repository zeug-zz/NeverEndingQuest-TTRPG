...
- Prefer reuse-first closure from module-local monsters, SRD/bestiary-compatible templates, and existing monster materialization reports before invoking any generator fallback.
