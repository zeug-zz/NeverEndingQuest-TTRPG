...
Define the corrected formatting conventions for the Homebrewery V3 adventure markdown output. This includes the metadata header format, section heading levels, and monster stat block structure including attack/damage line formatting.
