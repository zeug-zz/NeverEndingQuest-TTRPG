...
Define the data hygiene rules for loading NEQ module data when building Homebrewery adventure documents. The writer SHALL prefer `_BU` files for structural data but merge narrative-enriched fields from live files where BU entries are empty.
