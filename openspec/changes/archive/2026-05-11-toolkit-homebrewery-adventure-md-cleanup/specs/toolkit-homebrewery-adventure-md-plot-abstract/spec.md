...
Define the plot abstract generation for the adventure document introduction. The builder SHALL provide a concise narrative summary of the module's entire plot chain, using LLM summarization with deterministic fallback on failure.
