# toolkit-source-fidelity-artifact-contract Specification

## Purpose

Define the contract for the module-level `source_fidelity_report.json` artifact used by publishability audit and build report surfacing.
