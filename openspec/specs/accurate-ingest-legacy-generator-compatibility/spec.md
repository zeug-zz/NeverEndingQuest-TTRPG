...
Ensure generator source-lock changes do not break existing ModuleBuilder behavior for non-source concept builds and explicit seed writer support modes. All source-lock tests must remain provider-free.
