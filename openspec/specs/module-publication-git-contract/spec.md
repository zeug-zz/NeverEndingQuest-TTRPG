# module-publication-git-contract Specification

## Purpose

Define which module files MUST be tracked or ignored when a module is publication-ready, establishing a clear `.gitignore` contract for published modules.
