...
Serialize a source-faithful builder narrative from the builder blueprint so downstream build stages receive explicit source-lock instructions, constraint lists, and forbidden-invention guidance instead of a lossy freeform summary.
