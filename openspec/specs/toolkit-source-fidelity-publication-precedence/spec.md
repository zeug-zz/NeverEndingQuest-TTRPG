# toolkit-source-fidelity-publication-precedence Specification

## Purpose

Define the deterministic precedence order for source-fidelity status loading in publishability audit, ensuring module-level reports take priority over stale benchmark data.
