...
Provide deterministic entity candidate triage decisions for accurate-ingest source extraction so narrative phrases, plot notes, and tone markers are not promoted into NPC, monster, or scene-actor rosters.
