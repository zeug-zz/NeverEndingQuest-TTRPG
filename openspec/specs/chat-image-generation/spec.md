...
Define compatibility requirements for chat-triggered image generation so the runtime supports both URL-backed and base64-backed image responses and surfaces reliable browser-renderable outputs.
