...
Ensure reconcile-first same-module travel validation recognizes authored cross-area routes, allowing destinations in different areas of the same module to pass topology safety checks when valid graph paths exist.
