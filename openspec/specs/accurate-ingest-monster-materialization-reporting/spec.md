# Accurate-Ingest Monster Materialization Reporting

## Purpose

Define deterministic report metadata and diagnostic visibility for source monster and encounter handling during accurate-ingest materialization.
