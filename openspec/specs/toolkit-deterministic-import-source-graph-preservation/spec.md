# toolkit-deterministic-import-source-graph-preservation Specification

## Purpose
Source metadata preservation in deterministic import for downstream source graph and fidelity stages.
