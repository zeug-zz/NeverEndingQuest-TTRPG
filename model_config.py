...
ACTION_PREDICTION_MODEL = "gpt-5.6-luna"  # Use full model for accurate action prediction
...
NPC_BUILDER_MODEL = "gpt-5.6-luna"                # Used in npc_builder.py
ADVENTURE_SUMMARY_MODEL = "gpt-5.6-luna"
CHARACTER_VALIDATOR_MODEL = "gpt-5.6-luna"    # Used in adv_summary.py
PLOT_UPDATE_MODEL = "gpt-5.6-luna"          # Used in plot_update.py
PLAYER_INFO_UPDATE_MODEL = "gpt-5.6-luna"   # Used in update_player_info.py
NPC_INFO_UPDATE_MODEL = "gpt-5.6-luna"      # Used in update_npc_info.py
MONSTER_BUILDER_MODEL = "gpt-5.6-luna"
ENCOUNTER_UPDATE_MODEL = "gpt-5.6-luna"
LEVEL_UP_MODEL = "gpt-5.6-luna"                  # Used in level_up.py

# --- Transition Validation Model ---
TRANSITION_VALIDATOR_MODEL = "gpt-5.6-luna"  # Used in transition_validator.py
TRANSITION_VALIDATOR_TEMPERATURE = 0.3                   # Low temp for analytical reasoning

# --- Token Optimization Models ---
DM_MINI_MODEL = "gpt-5.6-luna"              # Used for simple conversations and plot-only updates
DM_FULL_MODEL = "gpt-5.6-luna"                   # Used for complex actions requiring JSON operations
...
GPT5_MINI_MODEL = "gpt-5.6-luna"              # gpt-5.6-luna GPT-5 family model for testing
GPT5_FULL_MODEL = "gpt-5.6-luna"                   # gpt-5.6-luna GPT-5 family model (kept for compatibility, not used)
...
ENABLE_ACCURATE_INGEST_FIDELITY_REVIEW_PANEL = False   # Pause accurate-ingest uploads for source-fidelity review before build (default: OFF)
...
NARRATIVE_COMPRESSION_MODEL = "gpt-5.6-luna"  # For general narrative compression
LOCATION_COMPRESSION_MODEL = "gpt-5.6-luna"        # For location encounter compression
